...
export const Footer: FC = () => {
  ...
  const socials = [
    ...
    { Icon: TiSocialLinkedin, key: "linkedin" },
    { Icon: TiSocialTwitter, key: "twitter" },
    { Icon: TiSocialYoutube, key: "youtube" },
  ];
            ...
            <ul className="flex flex-col gap-3">
              ...
              {menuOne.map((item) => (
                <li key={item}>
                  ...
                  >
                    <i className="me-2 inline-block h-4 w-4" />
                    {item}
                  </a>
                </li>
              ))}
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    <button
                      ...
                      className="hover:bg-primary-hover hover:border-primary-hover border-primary bg-primary end-[6px] absolute top-[6px] inline-flex h-9 items-center justify-center rounded-md px-6 gap-2 text-white transition-all"
                    >
                      Subscribe
                    </button>
                  </div>
                ...
                <ul className="flex flex-wrap items-center gap-1">
                  {socials.map(({ Icon, key }) => (
                    <li key={key}>
                      ...
                      >
                        <Icon className="text-default-300 group-hover:text-white" />
                      </a>
                    </li>
                  ))}
                </ul>
      ...
      <div className="border-t border-white/10 py-6">
        <div className="md:text-start container flex h-full flex-wrap items-center justify-center gap-4 text-center md:justify-between lg:px-20">
          <p className="text-default-400 text-base font-medium">
            ...
            <a href="#">
              Design & Created{" "}
              <i className="inline h-4 w-4 fill-red-500 text-red-500" /> by
              @Kaosiso
            </a>
          </p>
          <p className="text-default-400 text-base font-medium">
