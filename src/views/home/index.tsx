...
export const HomeView: FC = ({ setOpenCreateModal}) => {
  return <section id="home" className="overflow-hidden pb-20 pt-[72px] " >
      ...
      <div className="container ">
        <div className="p-6">
          <div className="relative grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
            ...
            <div className="">
              <span className="text-primary bg-primary/20 rounded-md px-3 py-1 text-sm font-medium uppercase tracking-wider" >CREATE SOLANA TOKEN {pkg.version}</span>
              <h1 className="md:text-5xl/tight my-4 max-w-lg text-4xl font-medium text-white" >
              Now Create Solana token to without code

              </h1>
              <p className="text-default-300 md:text-lg" >Launch your solana token, All in one solana token development and deployment
              ...
              <div className="new_add_css">
                <a onClick={()=>setOpenCreateModal(true)
                ...
                } className="hover:bg-primary-hover pe-4 group mt-10 inline-flex items-center justify-center gap-2 rounded-full border border-white/10 ">
                  ...
                  <i data-lucide="image"> <MdGeneratingTokens/> </i>
